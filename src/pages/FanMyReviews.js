...
function FanMyReviews() {
  ...
  const fetchReviews = useCallback(async () => {
    ...
    setError(null);
    try {
      const id = user.id.toString().replace(/^fan_/, '').replace(/^creator_/, '');
      ...
      <main className="fan-creator-reviews-main">
        <div className="fan-creator-reviews-container">
          <header className="fan-creator-reviews-header">
            <Link to="/fan/dashboard" className="fan-creator-reviews-back" aria-label="Back to dashboard">
              ←
            </Link>

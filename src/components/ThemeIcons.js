...
/**
 * Theme icons. Like the icons in ProfileIcons.js these use currentColor so the
 * surrounding CSS token decides their colour in either theme.
 */
...
export function AppearanceIcon({ className, size = 24 }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
